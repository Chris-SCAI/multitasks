...
export default function LoginPage() {
  ...
  const isAnyLoading = loading || magicLinkLoading || googleLoading;
      ...
      <div className="w-full max-w-lg space-y-8">
        ...
        <div className="rounded-2xl border border-[#1E293B] bg-[#151D2E] p-8 shadow-lg">
          ...
          <div className="space-y-2">
            <Button
              variant="outline"
              className="w-full border-[#1E293B] bg-[#1C2640] text-lg font-semibold text-white hover:bg-[#243052] hover:text-white"
              size="lg"
