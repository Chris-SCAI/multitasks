    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0B1120] px-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="rounded-2xl border border-[#1E293B] bg-[#151D2E] p-6 shadow-lg">
          ...
          <div className="space-y-2">
            <Button variant="outline" className="w-full border-[#1E293B] bg-[#1C2640] text-lg font-semibold text-white hover:bg-[#243052] hover:text-white" size="lg">
            ...
            <Button variant="ghost" className="w-full text-lg font-semibold text-white hover:bg-[#1C2640] hover:text-white" size="lg">
